    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2>
                        <i class="fas fa-university text-primary"></i> ผลงานคณะ {{ $faculty }}
                    </h2>
                    <p class="text-muted mb-0">
                        <i class="fas fa-folder"></i> {{ $totalInFaculty }} ผลงาน
                    </p>
                </div>
            ...
            <!-- สาขาในคณะนี้ -->
            @if($majorsInFaculty->count() > 0)
                <div class="row mb-4">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0">
                                    <i class="fas fa-graduation-cap"></i> สาขาในคณะ {{ $faculty }}
                                </h5>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    @foreach($majorsInFaculty as $major)
                                        @php
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-3">
                                            <div class="card border-success h-100">
                                                <div class="card-body text-center">
                                                    ...
                                                    <p class="card-text">
                                                        <span class="badge bg-success fs-6">{{ $count }} ผลงาน</span>
                                                    </p>
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">
                        <i class="fas fa-list"></i> รายการผลงานคณะ {{ $faculty }} ({{ $portfolios->total() }} รายการ)
                    </h5>
                </div>
                <div class="card-body">
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <h5 class="text-muted">ยังไม่มีผลงานในคณะ {{ $faculty }}</h5>
